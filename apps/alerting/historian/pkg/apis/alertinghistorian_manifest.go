	...
	Versions: []app.ManifestVersion{
		{
			...
			Routes: app.ManifestVersionRoutes{
					...
					"/alertstate/query": {
						Post: &spec3.Operation{
							OperationProps: spec3.OperationProps{
								...
								OperationId: "createAlertstatequery",
															...
															Properties: map[string]spec.Schema{
																"current": {
																	SchemaProps: spec.SchemaProps{
																		...
																		Ref: spec.MustCreateRef("#/components/schemas/createAlertstatequeryState"),
																	},
																},
																"dashboardUID": {
																	SchemaProps: spec.SchemaProps{
				...
				Schemas: map[string]spec.Schema{
					"createAlertstatequeryAlertStateEntry": {
						SchemaProps: spec.SchemaProps{
							Type: []string{"object"},
							Properties: map[string]spec.Schema{
								"line": {
...
var customRouteToGoResponseType = map[string]any{
	"v0alpha1||<namespace>/alertstate/query|POST": v0alpha1.CreateAlertstatequery{},
}
...
var customRouteToGoRequestBodyType = map[string]any{
	"v0alpha1||<namespace>/alertstate/query|POST": v0alpha1.CreateAlertstatequeryRequestBody{},
}
